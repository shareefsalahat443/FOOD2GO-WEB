                        ...
                        <div className="ms-panel">
                            ...
                            <div className="ms-panel-body">
                                <Carousel id="arrowSlider" className="ms-arrow-slider carousel slide" data-ride="carousel" data-interval="false" indicators={false}>
                                    <Carousel.Item>
                                        <img className="d-block w-100" src="assets/img/FOOD2GO/banner-1.jpg" alt="First slide" />
                                        <div className="carousel-caption d-none d-md-block">
                                            <h3 className="text-white">Pizaa img 1</h3>
                                        </div>
                                    </Carousel.Item>
                                    <Carousel.Item>
                                        <img className="d-block w-100" src="assets/img/FOOD2GO/banner-2.jpg" alt="Second slide" />
                                        <div className="carousel-caption d-none d-md-block">
                                            <h3 className="text-white">Pizaa img 2</h3>
                                        </div>
                                    </Carousel.Item>
                                    <Carousel.Item>
                                        <img className="d-block w-100" src="assets/img/FOOD2GO/banner-3.jpg" alt="Third slide" />
                                        <div className="carousel-caption d-none d-md-block">
