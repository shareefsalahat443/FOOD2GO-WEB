                                ...
                                <Dropdown className="dropdown float-left">
                                    ...
                                    <Dropdown.Menu className="dropdown-menu">
                                        ...
                                        <li className="ms-scrollable ms-dropdown-list ms-members-list">
                                            <Link className="media p-2" to="#">
                                                <div className="mr-2 align-self-center">
                                                    <img src="/themes/themeforest/react/FOOD2GO/static/media/customer-3.994f7115956ad11b4438.jpg" className="ms-img-round" alt="people" />
                                                </div>
                                                <div className="media-body"> <span>John Doe</span>
                                                </div>
                                            </Link>
                                            <Link className="media p-2" to="#">
                                                <div className="mr-2 align-self-center">
                                                    <img src="/themes/themeforest/react/FOOD2GO/static/media/customer-2.2d3ca3b5defd10ad9666.jpg" className="ms-img-round" alt="people" />
                                                </div>
                                                <div className="media-body"> <span>Raymart Sandiago</span>
                                                </div>
                                            </Link>
                                            <Link className="media p-2" to="#">
                                                <div className="mr-2 align-self-center">
                                                    <img src="/themes/themeforest/react/FOOD2GO/static/media/customer-1.7000edbe83302e8b2857.jpg"className="ms-img-round" alt="people" />
                                                </div>
                                                <div className="media-body"> <span>Chihoo Hwang</span>
                                                </div>
                                            </Link>
                                        </li>
                                    </Dropdown.Menu>
