...
import shareef111 from '../../assets/img/FOOD2GO/shareef111.jpg';
        ...
        return (
            <nav className="navbar ms-navbar">
                ...
                <div className="logo-sn logo-sm ms-d-block-sm">
                    <Link className="pl-0 ml-0 text-center navbar-brand mr-0" to="/"> FOOD2GO </Link>
                </div>
                                ...
                                <Scrollbar className="ms-scrollable ms-dropdown-list">
                                    <Link className="media p-2" to="#">
                                        <div className="ms-chat-status ms-status-offline ms-chat-img mr-2 align-self-center">
                                            <img src="themes/themeforest/react/FOOD2GO/static/media/customer-6.503dd60834d59a561951.jpg" className="ms-img-round" alt="people" />
                                        </div>
                                    ...
                                    <Link className="media p-2" to="#">
                                        ...
                                        <div className="media-body"> <span>Dear John, I was told you bought FOOD2GO! Send me your feedback</span>
                    ...
                    <li className="ms-nav-item ms-nav-user dropdown">
                        <Dropdown className="custom-dropdown">
                            <Dropdown.Toggle as={NavLink} id="userDropdown" className="p-0">
                                <img className="ms-user-img ms-img-round" src={shareef111} alt="people" />
                            </Dropdown.Toggle>
                            <Dropdown.Menu className="dropdown-menu dropdown-menu-right user-dropdown" aria-labelledby="userDropdown">
                                <div className="dropdown-menu-header">
                                    <h6 className="dropdown-header ms-inline m-0"><span className="text-disabled">Welcome, Shareef Salahat</span></h6>
                                </div>
                                <div className="dropdown-divider" />
                                <div className="ms-dropdown-list">
                                    ...
                                    <Link className="media fs-14 p-2" to="/user-profile"> <span><i className="flaticon-gear mr-2" /> Account Settings</span>
                                    </Link>
