                ...
                <Scrollbar id="ms-side-nav" className="side-nav fixed ms-aside-scrollable ms-aside-left">
                    ...
                    <ul className="accordion ms-main-aside fs-14" id="side-nav-accordion">
                        ...
                        <li className="menu-item">
                            <Link to="#" className="has-chevron"> <span><i className="material-icons fs-16" >dashboard</i>Admin Dashboard </span>
                            </Link>
                        ...
                        {/* orders end */}
                         ...
                         {/* Restaurant */}
                         <li className="menu-item">
                            <Link to="#" className="has-chevron"> <span><i className="fas fa-clipboard-list fs-16" />Restaurants List </span>

                            </Link>

                             <ul id="customer" className="collapse" aria-labelledby="Restaurant" data-parent="#side-nav-accordion">
                                <li> <Link to="/restaurant-request" >Restaurant Request</Link>
                                </li>
                                <li> <Link to="restaurant-list" >Restaurant List</Link>
                                </li>
                            </ul >
                        </li >
                        {/* Restaurant end */}
