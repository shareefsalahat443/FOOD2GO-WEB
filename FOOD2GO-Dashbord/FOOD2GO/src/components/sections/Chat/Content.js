                                    ...
                                    <div className="ms-chat-header px-3">
                                        <div className="ms-chat-user-container media clearfix">
                                            <div className="ms-chat-status ms-status-online ms-chat-img mr-3 align-self-center">
                                                <img src="assets/img/FOOD2GO/customer-1.jpg" className="ms-img-round" alt="people" />
                                            </div>
                                                    ...
                                                    <ul>
                                                        <li className="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                                            <div className="ms-chat-status ms-status-away ms-has-new-msg ms-chat-img mr-3 align-self-center"> <span className="msg-count">3</span>
                                                                <img src="assets/img/FOOD2GO/customer-2.jpg" className="ms-img-round" alt="people" />
                                                            </div>
                                                            <div className="media-body ms-chat-user-info mt-1">
                                                        ...
                                                        <li className="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                                            <div className="ms-chat-status ms-status-online ms-chat-img mr-3 align-self-center">
                                                                <img src="assets/img/FOOD2GO/customer-3.jpg" className="ms-img-round" alt="people" />
                                                            </div>
                                                            <div className="media-body ms-chat-user-info mt-1">
                                                        ...
                                                        <li className="ms-chat-user-container ms-open-chat selected ms-deletable p-3 media clearfix">
                                                            <div className="ms-chat-status ms-status-offline ms-chat-img mr-3 align-self-center">
                                                                <img src="assets/img/FOOD2GO/customer-4.jpg" className="ms-img-round" alt="people" />
                                                            </div>
                                                            <div className="media-body ms-chat-user-info mt-1">
                                                        ...
                                                        <li className="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                                            <div className="ms-chat-status ms-status-busy ms-chat-img mr-3 align-self-center">
                                                                <img src="assets/img/FOOD2GO/customer-5.jpg" className="ms-img-round" alt="people" />
                                                            </div>
                                                            <div className="media-body ms-chat-user-info mt-1">
                                                        ...
                                                        <li className="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                                            <div className="ms-chat-status ms-status-online ms-chat-img mr-3 align-self-center">
                                                                <img src="assets/img/FOOD2GO/customer-6.jpg" className="ms-img-round" alt="people" />
                                                            </div>
                                                            <div className="media-body ms-chat-user-info mt-1">
                                                        ...
                                                        <li className="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                                            <div className="ms-chat-status ms-status-online ms-chat-img mr-3 align-self-center">
                                                                <img src="assets/img/FOOD2GO/customer-7.jpg" className="ms-img-round" alt="people" />
                                                            </div>
                                                            <div className="media-body ms-chat-user-info mt-1">
                                                                <h6>John Doe</h6>  <span className="ms-chat-time">3 Days ago</span>
                                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in arcu turpis. Nunc</p>
                                                        ...
                                                        <li className="ms-chat-user-container ms-open-chat ms-deletable p-3 media clearfix">
                                                            <div className="ms-chat-status ms-status-online ms-chat-img mr-3 align-self-center">
                                                                <img src="assets/img/FOOD2GO/customer-8.jpg" className="ms-img-round" alt="people" />
                                                            </div>
                                                            <div className="media-body ms-chat-user-info mt-1">
                                                                <h6>John Doe</h6>  <span className="ms-chat-time">3 Days ago</span>
                                                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In in arcu turpis. Nunc</p>
                                                    ...
                                                    <ul>
                                                        <li className="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                                            ...
                                                            <div className="media-body ms-chat-user-info mt-1">
                                                                ...
                                                                <ul className="ms-group-members clearfix mt-3 mb-0">
                                                                    <li>
                                                                        <img src="assets/img/FOOD2GO/customer-2.jpg" alt="member" />
                                                                    </li>
                                                                    <li>
                                                                        <img src="assets/img/FOOD2GO/customer-3.jpg" alt="member" />
                                                                    </li>
                                                                    <li>
                                                                        <img src="assets/img/FOOD2GO/customer-4.jpg" alt="member" />
                                                                    </li>
                                                        ...
                                                        <li className="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                                            ...
                                                            <div className="media-body ms-chat-user-info mt-1">
                                                                ...
                                                                <ul className="ms-group-members clearfix mt-3 mb-0">
                                                                    <li>
                                                                        <img src="assets/img/FOOD2GO/customer-8.jpg" alt="member" />
                                                                    </li>
                                                                    <li>
                                                                        <img src="assets/img/FOOD2GO/customer-9.jpg" alt="member" />
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </li>
                                                        <li className="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                                            <div className="ms-chat-img mr-3 align-self-center">
                                                                <img src="assets/img/FOOD2GO/customer-10.jpg" className="ms-img-round" alt="people" />
                                                            </div>
                                                            <div className="media-body ms-chat-user-info mt-1">
                                                                <h6>John Doe</h6>
                                                                <Link to="/chat" className="ms-chat-time"> <i className="flaticon-chat" />
                                                                ...
                                                                <ul className="ms-group-members clearfix mt-3 mb-0">
                                                                    <li>
                                                                        <img src="assets/img/FOOD2GO/customer-1.jpg" alt="member" />
                                                                    </li>
                                                                    <li>
                                                                        <img src="assets/img/FOOD2GO/customer-3.jpg" alt="member" />
                                                                    </li>
                                            ...
                                            <Tab.Pane eventKey="contacts-2">
                                                <Scrollbar className="ms-scrollable">
                                                    <ul>
                                                        ...
                                                        <li className="ms-chat-user-container ms-open-chat p-3 media clearfix">
                                                            <div className="ms-chat-img mr-3 align-self-center">
                                                                <img src="assets/img/FOOD2GO/customer-9.jpg" className="ms-img-round" alt="people" />
                                                            </div>
                                                            <div className="media-body ms-chat-user-info mt-1">
                                                                <h6>John Doe</h6>
                                                                <Link to="/chat" className="ms-chat-time"> <i className="flaticon-chat" />
